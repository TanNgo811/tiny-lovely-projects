...
export class UsersController {
  ...
  getProfile(@GetUser() user: User) {
    // GetUser is a custom decorator we'll create
  ...
  @ApiOperation({
    summary:
      'Get a user by ID (requires authentication, further checks needed for non-admin)',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Update a user (requires authentication, further checks needed)',
  })
