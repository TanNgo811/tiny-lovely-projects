import { Controller, Post, Body, HttpCode, HttpStatus, UseGuards, Get, Request, UseInterceptors, ClassSerializerInterceptor, UnauthorizedException } from '@nestjs/common';
...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Current user profile.', type: User /* Specify response type for Swagger */ })
